...
| Integration | Vitest, ExcelJS               | Qualification, squads, ratings, simulation, probability, game flow, seed, workbook |
...
Game-flow tests validate tournament creation, accelerated completion to one
champion, simultaneous-batch tracking, save migration, invalid import rejection,
and browser save/export/reset behavior.
